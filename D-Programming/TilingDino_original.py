    ...
    def convert(self, lines):
        ...
        for c in range(len(matrix)):
            for r in range(len(matrix[c])): 
                if lines[c][r] == '#':
                    ...
                    num += 1                 
                    #color[c][r] = str(r)+' '+str(c)

        graph = networkx.DiGraph()
        for c in range(len(matrix)):
            for r in range(len(matrix[c])): 
                if matrix[c][r] != 0 and color[c][r] == 0:
                    ...
                    if c+1 <= len(matrix)-1 and matrix[c+1][r] != 0: #and color[c+1][r] == 0:
                        ...
                        color[c][r],color[c+1][r] = 'marked', 'marked'
                    ...
                    if r-1 >= 0 and matrix[c][r-1] != 0: #and color[c][r-1] == 0:
                        ...
                        color[c][r],color[c][r-1] = 'marked', 'marked'
        ...
        for c in range(len(matrix)):
            for r in range(len(matrix[c])):                 
                ...
                if not graph.in_edges(nbunch=str(r)+' '+str(c)) and matrix[c][r] != 0:
                    graph.add_edge('start', matrix[c][r], capacity=1)
                    color[c][r] = 'marked'
                # check if a node connects to anything 
                if not graph.out_edges(nbunch=str(r)+' '+str(c)) and matrix[c][r] != 0:
